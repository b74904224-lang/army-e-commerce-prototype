...
// Folding mat in cover — the main.webp slot held an incorrect preview, so it is
// excluded. The catalog card, product-page default, first thumbnail and
// cart/checkout thumbnail all use the first real gallery photo (gallery-1.webp);
// the remaining gallery photos follow. No processed / nature-background images.
const REAL_FOLDING_MAT_COVER = [
  "/images/products-real/folding-mat-cover/gallery-1.webp",
  "/images/products-real/folding-mat-cover/gallery-2.webp",
  "/images/products-real/folding-mat-cover/gallery-3.webp",
]
...
// photo-00035 shows the dark/black foam mat (only the carry straps are olive),
// so it belongs to the Black gallery, not Olive Green.
const VG_L1_TAC_BLACK = VG("army-l1-tactical", "black", ["photo-00118.jpg", "photo-00035.jpg"])
const VG_L1_TAC_OLIVE = VG("army-l1-tactical", "olive-green", ["photo-00121.jpg", "photo-00122.jpg"])
...
export const products: Product[] = [
  ...
  // 4 — Army L1 sleeping mat in Multicam / Pixel baul cover (roll-mats)
  {
    ...
    descriptionRu:
      "Чехлами-баулами комплектуются только коврики толщиной 15 мм, ламинированные с одн��й стороны, в цветах Чёрный или Olive Green. Вместо традиционного крепления использу��тся многофункциональный чехол-баул.\n\nТакой чехол можно использовать не только для транспортировки коврика, но и как удобную и надёжную туристическую сумку. Он имеет цилиндрическую форму, систему MOLLE и несколько удобных транспортных ручек. Сверху закрывается влагос��ойкой молнией, а верхняя часть образует дополнительный защитный клапан, который фиксируется на трёхщелевую пряжку. Чехол выполнен из прочной ткани с повышенной износостойкостью. Доступные цвета: камуфляж Пиксель, камуфляж Мультикам или однотонный тёмно-зелёный.",
    specifications: {
