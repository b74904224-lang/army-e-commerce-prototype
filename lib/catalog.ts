...
export const products: Product[] = [
  // 1 — Folding mat in cover (folding-mats)
  {
    ...
    price: 0,
    description:
      "The product is designed to improve comfort during long stays in field conditions, creating reliable thermal and moisture insulation and additional cushioning from hard, uneven ground. The mat consists of 10 sections, allowing the insulation thickness to be adjusted by changing its length — for example, forming a comfortable headrest. It features a quick-roll and fixation system and can be attached to a backpack using the MOLLE system; the fixing straps also serve as carrying handles. The outer cover is made of durable waterproof fabric, and the MONOISOL filling is completely waterproof with excellent cushioning, keeping its thickness for a long time. Available in 12 mm and 15 mm thicknesses.",
    descriptionUa:
      "Виріб призначений для підвищення комфорту при тривалому перебуванні в польових умовах, створюючи надійний теплоізоляційний та вологозахисний бар'єр і додатковий амортизаційний захист від твердої та нерівної поверхні землі. Килим складається з 10 секцій, що дозволяє регулювати товщину ізоляції шляхом зміни довжини — наприклад, зробити зручну підкладку під голову. Має систему швидкого згортання та фіксації, кріплення до рюкзака за допомогою системи MOLLE; лямки-фіксатори одночасно служать ручками для перенесення. Зовнішній чохол виготовлений з міцної водонепроникної тканини, а наповнювач MONOISOL повністю водонепроникний і має високі амортизаційні властивості. Доступний у двох варіантах товщини: 12 мм та 15 мм.",
    descriptionRu:
      "Изделие предназначено для повышения комфорта при длительном пребывании в полевых условиях, создавая надёжную тепло- и влагоизоляцию, а также дополнительную амортизационную защиту от твёрдой и неровной поверхности земли. Коврик состоит из 10 секций, что позволяет регулировать толщину изоляции за счёт изменения длины — например, сделать удобную подушку под голову. Оснащён системой быстрого сворачивания и фиксации, креплением к рюкзаку с помощью системы MOLLE; лямки-фиксаторы одновременно выполняют функцию ручек для переноски. Внешний чехол изготовлен из прочной водонепроницаемой ткани, а наполнитель MONOISOL полностью водонепроницаем и обладает хорошими амортизирующими свойствами. Доступен в двух вариантах толщины: 12 мм и 15 мм.",
    specifications: {
  ...
  // 2 — Army L1 sleeping mat, standard attachment (roll-mats)
  {
    ...
    price: 0,
    description:
      "The Army L1 range of field insulated sleeping mats offers a wide variety in color, thickness and attachment type. All products feature a protective laminated surface that significantly improves their performance. Available in Black and Olive Green, with an increased thickness of 12 mm or 15 mm. This version uses the standard military attachment — two strong polypropylene straps with quick tightening. Despite larger dimensions and weight compared to compact models, these mats significantly increase comfort during long stays in field conditions.",
    descriptionUa:
      "Товарний асортимент спальних польових ізоляційних килимів Army L1 має широку варіацію за кольором, товщиною та видом кріплення. Усі вироби мають захисну ламіновану поверхню, що значно підвищує їх експлуатаційні властивості. Представлені у двох кольорах — чорному та Olive Green, зі збільшеною товщиною 12 або 15 мм. Ця модель має стандартне армійське кріплення — дві міцні поліпропіленові стрічки з швидким затягуванням. Незважаючи на більші габарити та вагу порівняно з компактними моделями, ці килими значно підвищують комфорт при тривалому перебуванні в польових умовах.",
    descriptionRu:
      "Товарный ассортимент спальных полевых изоляционных ковриков Army L1 отличается широким выбором по цвету, толщине и типу крепления. Все изделия имеют защитную ламинированную поверхность, что существенно повышает их эксплуатационные свойства. Представлены в двух цветах — чёрном и Olive Green, с увеличенной толщиной 12 или 15 мм. Эта модель имеет стандартное армейское крепление — две прочные полипропиленовые ленты с быстрым затягиванием. Несмотря на большие габариты и вес по сравнению с компактными моделями, эти коврики значительно повышают комфорт при длительном пребывании в полевых условиях.",
    specifications: {
  ...
  // 3 — Army L1 sleeping mat, tactical attachment (roll-mats)
  {
    ...
    price: 0,
    description:
      "The Army L1 range of field insulated sleeping mats offers a wide variety in color, thickness and attachment type. All products feature a protective laminated surface that significantly improves their performance. Available in Black and Olive Green, with an increased thickness of 12 mm or 15 mm. This version uses an improved tactical attachment with an additional handle for convenient carrying or attaching to a backpack or body. Despite larger dimensions and weight, these mats significantly improve comfort during long stays in field conditions.",
    descriptionUa:
      "Товарний асортимент спальних польових ізоляційних килимів Army L1 має широку варіацію за кольором, товщиною та видом кріплення. Усі вироби мають захисну ламіновану поверхню, що суттєво підвищує їх експлуатаційні властивості. Представлені у двох кольорах — Чорному та Olive Green, зі збільшеною товщиною 12 або 15 мм. Ця модель має покращене тактичне кріплення з додатковою ручкою для зручного перенесення або кріплення до рюкзака чи тулуба. Незважаючи на більші габарити та вагу, ці килими значно покращують комфорт при тривалому перебуванні в польових умовах.",
    descriptionRu:
      "Товарный ассортимент спальных полевых изоляционных ковриков Army L1 отличается широким выбором по цвету, толщине и типу крепления. Все изделия имеют защитную ламинированную поверхность, что существенно повышает их эксплуатационные свойства. Представлены в двух цветах — чёрном и Olive Green, с увеличенной толщиной 12 или 15 мм. Эта модель имеет улучшенное тактическое крепление с дополнительной ручкой для удобного переноса или крепления к рюкзаку или телу. Несмотря на большие габариты и вес, эти коврики значительно повышают комфорт при длительном пребывании в полевых условиях.",
    specifications: {
      "Size": "1900×600×12/15 mm",
      "Color": "Black / Olive Green",
      "Surface": "Laminated",
  ...
  // 4 — Army L1 sleeping mat in Multicam / Pixel baul cover (roll-mats)
  {
    ...
    price: 0,
    description:
      "Only 15 mm thick mats, single-side laminated, in Black or Olive Green come with baul covers. Instead of traditional straps, a multifunctional baul cover is used, which works not only for transporting the mat but also as a reliable tourist bag. It has a cylindrical shape, MOLLE system and several carrying handles; the top closes with a waterproof zipper and forms an additional protective flap secured with a three-slot buckle. The cover is made of durable, high-wear-resistance fabric. Available colors: Pixel camouflage, Multicam camouflage or solid dark green.",
    descriptionUa:
      "Чохлами-баулами комплектуються лише килими товщиною 15 мм, ламіновані з однієї сторони, у кольорах Чорний або Olive Green. Замість традиційного кріплення використовується багатофункціональний чохол-баул, який можна використовувати не тільки для транспортування килима, але й як зручну та надійну туристичну сумку. Він має циліндричну форму, систему MOLLE та декілька транспортувальних ручок; зверху застібається водостійкою блискавкою, а верх утворює додатковий захисний клапан, що фіксується на трищілинну пряжку. Чохол виготовлений з міцної тканини з підвищеною зносостійкістю. Доступні кольори: камуфляж Піксель, камуфляж Мультикам або однотонний темно-зелений.",
    descriptionRu:
      "Чехлами-баулами комплектуются только коврики толщиной 15 мм, ламинированные с одной стороны, в цветах Чёрный или Olive Green. Вместо традиционного крепления используется многофункциональный чехол-баул, который можно использовать не только для транспортировки коврика, но и как удобную и надёжную туристическую сумку. Он имеет цилиндрическую форму, систему MOLLE и несколько транспортных ручек; сверху закрывается влагостойкой молнией, а верхняя часть образует дополнительный защитный клапан, фиксируемый на трёхщелевую пряжку. Чехол выполнен из прочной ткани с повышенной износостойкостью. Доступные цвета: камуфляж Пиксель, камуфляж Мультикам или однотонный тёмно-зелёный.",
    specifications: {
  ...
  // 5 — Gymnastic mat L0 (roll-mats)
  {
    ...
    price: 0,
    description:
      "The product is designed for sports training at home or fitness exercises in gyms. The mat consists of two layers of high-density colored foam polyethylene. The set includes two colorful fixing elastic bands that conveniently secure the mat in the rolled state. The ArmY gymnastic mat is a great helper for both children and adults during amateur workouts or active recreation.",
    descriptionUa:
      "Виріб призначений для використання на спортивних тренуваннях вдома або при виконанні фітнес-вправ у спортивних залах. Килимок складається з двох різнокольорових шарів спіненого поліетилену підвищеної щільності. У комплекті є дві фіксуючі гумки барвистого кольору, які зручно фіксують виріб у згорнутому стані. Спортивний килимок ArmY стане у нагоді як дітям, так і дорослим під час аматорських тренувань або активного відпочинку.",
    descriptionRu:
      "Изделие предназначено для использования на спортивных тренировках дома или при выполнении фитнес-упражнений в спортивных залах. Коврик состоит из двух разноцветных слоёв вспененного полиэтилена повышенной плотности. В комплекте имеются две цветные фиксирующие резинки, которые удобно фиксируют изделие в свёрнутом состоянии. Спортивный коврик ArmY станет отличным помощником как для детей, так и для взрослых при любительских тренировках или активном отдыхе.",
    specifications: {
      "Size": "1800×550×12 mm",
