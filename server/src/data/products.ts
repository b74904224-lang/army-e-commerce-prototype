...
export const products: Product[] = [
  ...
  // 5 — Gymnastic mat L0 (roll-mats)
  {
    ...
    descriptionRu:
      "Изделие предназначено для использования на спортивных тренировках дома или при выполнении фитнес-упражнений в спортивных залах. Ков��ик состоит из двух разноцветных слоёв вспененного полиэтилена повышенной плотности. В комплекте имеются две цветные фиксирующие резинки, которые удобно фиксируют изделие в свернутом состоянии.\n\nСпортивный коврик ArmY станет отличным помощником как для детей, так и для взрослых при любительских тре��ировках или активном отдыхе.",
    specifications: {
      "Size": "1800×550×12 mm",
  ...
  // 12 — Insulated field seat (field-seats)
  {
    ...
    specificationsRu: {
      ...
      "Лента": "Эластичная полиамидн��я, тёмно-зелёная, 25 мм, толщина 1,8–2 мм, плотность 22 г/м.п.",
      "Пружинность": "25 параллельных силиконовых резинок",
